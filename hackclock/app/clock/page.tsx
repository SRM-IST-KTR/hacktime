...
export const metadata: Metadata = {
  title: "Participant Clock View for Live Hackathons",
  description:
    "Open the participant clock view for a live hackathon room and follow the active countdown and announcements.",
  robots: {
    index: false,
    follow: false,
  },
